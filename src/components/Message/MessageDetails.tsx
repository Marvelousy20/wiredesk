        ...
        <div className="flex justify-between items-center w-full">
          <div className="flex gap-2">
            <Image
              ...
              height={25}
            />
            <h1 className="font-semibold text-black">James Books</h1>
          </div>
          ...
          <div className="flex items-center gap-x-3">
            ...
            <div className="flex gap-x-3 items-center">
              <span className="bg-[#F1F0F4] hover:bg-[#EEEFF1]  rounded-[10px] p-1.5 hover:scale-110 transition-transform duration-200">
              ...
              <Button className="bg-[#6941C6] text-white p-1.5 px-2 text-sm font-medium rounded-[5px]">
                {isOpen ? (
                  <span className="flex gap-1 items-center">
                    {/* <MdOutlineArchive size={20} /> */}
                    <Image
                      src="/sidebar/message.svg"
                      alt="close"
                      width={20}
                      height={20}
                    />
          ...
          <div className="mt-3">
            <div>
              <div className="flex justify-end">
                <h1 className="bg-[#EBE7F8] rounded-[10px] p-4 max-w-[27rem]">
              ...
              <div className="items-center px-4 py-4 bg-white rounded-[5px] shadow-sides mt-4 w-full">
                <div>
                  <input
                    ...
                    className="flex-grow p-2 border border-gray-300 rounded-lg mr-2 w-full border-none"
                  />
                </div>
                ...
                <div className="flex justify-between mt-5">
                  ...
                  <div className="flex gap-2.5 items-center justify-end">
                    ...
                    <button
                      className="bg-[#6941C6] text-white rounded-[5px] px-2.5 py-[0.313rem] flex items-center"
