          ...
          <DialogPanel className="w-full max-w-[75rem] bg-white backdrop-blur-2xl duration-300 ease-out data-[closed]:transform-[scale(95%)] data-[closed]:opacity-0">
            <div className="bg-[#2325290D] bg-opacity-5 flex py-[3.93rem] justify-between px-[3.125rem]">
              ...
              <div className="flex flex-col">
                <button className="text-white bg-black rounded-[5px] text-xl px-2.5 py-[0.3125rem]">
                  Install now
                </button>
                    ...
                    <TabPanels className="mt-9">
                      <TabPanel>
                        <div className="text-black text-sm">
                          ...
                          inbox — keeping all of your customer communications in
                          one place and enabling you to respond faster to your
                          leads and users. With the Instagram app, you can read,
                          manage and respond to all private messages right from
                          your inbox. No more switching tabs or managing
                          multiple queues. <br /> <br /> Instagram messages can
                          be routed directly to your Unassigned inbox, or you
                          can automatically assign them to the right team or
                          teammate using assignment rules. Plus, anyone who
                          messages you will be added to Intercom as a lead or
                          user, making it easy to track all of your
                          conversations and customer data in one place and
